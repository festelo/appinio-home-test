// THIS CODE WAS TAKEN FROM FLUTTER CODE SOURCE AND SLIGHTLY MODIFIED TO PROVIDE
// THE BEST EXPERIENCE FOR THIS SHOWCASE

// Copyright 2014 The Flutter Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

// ignore_for_file: omit_local_variable_types, parameter_assignments, comment_references, always_put_required_named_parameters_first, lines_longer_than_80_chars, prefer_asserts_with_message, prefer_int_literals, cascade_invocations, require_trailing_commas
...
class _DraggableScrollableSheetScrollPosition
  ...
  final Set<AnimationController> _ballisticControllers =
      <AnimationController>{};
  bool get listShouldScroll => pixels > -50.0;
